...
static doublereal c_b281 = .001;
static doublereal c_b282 = .9;
static doublereal c_b283 = .1;
...
/*        Check the input arguments for errors. */
	...
	if (s_cmp(task, "ERROR", (ftnlen)5, (ftnlen)5) == 0) {
	    prn3lb_(n, &x[1], f, task, iprint, &info, &itfile, &iter, &nfgv, &
		    nintol, &nskip, &nact, &sbgnrm, &c_b10, &nseg, word, &
...
/*                               Line search is impossible. */
    ...
    dcsrch_(f, gd, stp, &c_b281, &c_b282, &c_b283, &c_b10, stpmx, csave, &
